...
def get_input_data() -> pd.DataFrame:
    """Load both CSV files, rename type columns, and concatenate."""
    ...
    # Set the default classification column
...
def de_duplication(data: pd.DataFrame):
    """Remove duplicate interaction content within each ticket."""
...
def noise_remover(df: pd.DataFrame):
    """Remove noise patterns from ticket summaries and interaction content."""
...
def translate_to_en(texts: list):
    """Placeholder — translation is skipped in this environment."""
    return texts
